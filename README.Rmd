...
[![Travis build status](https://travis-ci.org/jforbes14/eechidna.svg?branch=master)](https://travis-ci.org/jforbes14/eechidna) [![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/eechidna)](http://cran.r-project.org/package=eechidna) [![](http://cranlogs.r-pkg.org/badges/grand-total/eechidna)](http://cran.rstudio.com/web/packages/eechidna/index.html)

```{r include = F}
# Travis badge linked with ropensci - current badge linked with my git
