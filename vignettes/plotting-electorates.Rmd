...
This vignette describes how to make a map of the Australian election results. It requires merging polygons of the electoral regions, with election results using the electorate id's or unique names. The `nat_map_2016` contains the electorate polygons and `aec2016_fp_electorate` contains the results of the 2016 Federal election.
...
library(ggplot2)
#data(nat_data_2016)
load("/Users/Jeremy/Documents/R/eechidna/data/my/nat_data_2016.rda")
#data(nat_map_2016)
load("/Users/Jeremy/Documents/R/eechidna/data/my/nat_map_2016.rda")
load("/Users/Jeremy/Documents/R/eechidna/data/aec2016_fp_electorate.rda")
...
cart.winners <- aec2016_fp_electorate %>% filter(Elected == "Y") %>% 
  select(Electorate, PartyNm) %>% 
  merge(nat_data_2016, by.x="Electorate", by.y="elect_div")
...
ggplot(data=nat_map_2016) +
  ...
  geom_point(data=cart.winners.grouped, aes(x=x, y=y, colour=PartyNm), size=1.5, alpha=0.8) +
