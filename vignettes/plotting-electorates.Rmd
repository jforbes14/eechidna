...
data(nat_data16)
#load("/Users/Jeremy/Documents/R/eechidna/data/my/nat_data16.rda")
data(nat_map16)
#load("/Users/Jeremy/Documents/R/eechidna/data/my/nat_map16.rda")
data(fp16)
...
cart.winners <- fp16 %>% filter(Elected == "Y") %>% 
  select(DivisionNm, PartyNm) %>% 
  merge(nat_data16 %>% chr_upper(), by.x="DivisionNm", by.y="elect_div")
