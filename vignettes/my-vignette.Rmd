...
Please see the vignettes on our [webpage](https://INSERT-EECHIDNA-WEBSITE.IO). These detail the procedures used to obtain the election data, Census data and electorate maps, as well as the Census imputation method.
