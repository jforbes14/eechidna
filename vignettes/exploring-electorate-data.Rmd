...
`echidnaR` is an R package that makes it easy to look at the data from the 2011 Australian Census, and the 2013 Federal Election.
...
ggplot(data = abs2011,
       aes(x = Unemployed)) + 
  geom_density(fill = "salmon", bw="SJ") + 
