...
```{r loadsF, eval = F}
sF_13 <- loadShapeFile("path-to-your-shapefiles/national-midmif-16122011/COM20111216_ELB.MIF")
sF_16 <- loadShapeFile("path-to-your-shapefiles/national-midmif-09052016/COM_ELB.TAB")
```
```{r mapping, eval = F}
