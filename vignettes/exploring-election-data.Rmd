...
----------------------- | ------------------------------------------------------------
fp_pp                   | first preference votes for candidates at each polling place
fp16                    | first preference votes for candidates at each electorate (2016)
tpp_pp                  | two party preferred votes for candidates at each polling place
tpp16                   | two party preferred votes for candidates at each electorate (2016)
tcp_pp                  | two candidate preferred votes for candidates at each polling place
...
The `pp` suffix stands for polling place (polling booth), and these data sets contain votes from all six elections. The variable `year` represents the election year, so an individual years' polling booth data can be easily obtained using `dplyr::filter`.
