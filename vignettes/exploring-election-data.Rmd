...
This vignette documents how to access the data from the 2013 Federal Election (House of Representatives (first preferences only). In this vignette we show a few typical methods to explore the data, inspired by [Peter Ellis's](https://peterellisblog.com/) work on NZ election data. 
...
We can also comparing party votes of several parties (also inspired by  [Peter Ellis's](https://peterellisblog.com/)):
