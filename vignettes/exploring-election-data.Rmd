...
Now we can easily explore some relationships between the census data and the two party preferring voting patterns. For example, what census variable mostly strongly correlates with the percentage that vote Labor?
...
r2s <- apply(census_and_election[, census_variables], 
             2, 
             function(x) summary(lm(x ~ census_and_election$Average_Australian_Labor_Party_Percentage_in_electorate))$r.squared)
