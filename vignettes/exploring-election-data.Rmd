...
```{r plot_total_votes_for_parties,  fig.height = 6, eval = FALSE}
...
```{r who_won_least_votes_prop, eval = FALSE}
...
```{r plot_prop_particular_party, fig.height = 12, fig.width=10, eval = FALSE}
