...
For the 2016 election, the national electorate boundaries are given in mapinfo format ([http://www.aec.gov.au/Electorates/gis/files/nt-midmif-07022017.zip](http://www.aec.gov.au/Electorates/gis/files/nt-midmif-07022017.zip)). The `rgdal` library can be used to read this format:
