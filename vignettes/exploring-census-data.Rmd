---
title: "Exploring the 2016 Census data"
...
output: 
    rmarkdown::html_vignette:
        toc: true
vignette: >
  %\VignetteIndexEntry{Exploring the 2016 Census data}
...
`eechidna` (Exploring Election and Census Highly Informative Data Nationally for Australia) is an R package that makes it easy to look at the data from the 2016 Australian Census, and the 2016 Federal Election.

This vignette documents how to access the data from the 2016 Census. We show a few typical methods to explore the data.
