...
CED (Commonwealth Electoral Divison) Lists:
- CED2001.csv
- CED2006.csv
...
# Extract information from relevant sheets, for each CED
...
CED_list_2006$State <- as.character(CED_list_2006$State)

for (i in 1:nrow(CED_list_2006)) {
  if(CED_list_2006$State[i] == "VIC") {
    CED_list_2006$State[i] <- "Vic"
  }
  else if(CED_list_2006$State[i] == "QLD") {
    CED_list_2006$State[i] <- "Qld"
  }
  else if(CED_list_2006$State[i] == "TAS") {
    CED_list_2006$State[i] <- "Tas"
  }
}

CED_list_2006_e07 <- read.csv("/Users/Jeremy/Documents/R/Data/Raw-Supplement/CED_Definitions/CED2006_07.csv")
...
abs2006 <- data.frame(ID = CED_list_2006$CED, Electorate = CED_list_2006$Electorate, State = CED_list_2001$State, Population = 0, Area = 0, MedianPersonalIncome = 0, Unemployed = 0, LFParticipation = 0, BachelorAbv = 0, Christianity = 0, Catholic = 0, Buddhism = 0, Islam = 0, Judaism = 0, NoReligion = 0, Age00_04 = 0, Age05_14 = 0, Age15_19 = 0, Age20_24 = 0, Age25_34 = 0, Age35_44 = 0, Age45_54 = 0, Age55_64 = 0, Age65_74 = 0, Age75_84 = 0, Age85plus = 0, BornOverseas = 0, Indigenous = 0, EnglishOnly = 0, OtherLanguageHome = 0, Married = 0, DeFacto = 0, FamilyRatio = 0, CurrentlyStudying = 0, HighSchool = 0, InternetUse = 0, InternetAccess = 0, AusCitizen = 0, AverageHouseholdSize = 0, MedianHouseholdIncome = 0, MedianFamilyIncome = 0, MedianRent = 0, MedianLoanPay = 0, MedianAge = 0, EmuneratedElsewhere = 0, Volunteer = 0, PersonalIncome_NS = 0, FamilyIncome_NS = 0, HouseholdIncome_NS = 0, Rent_NS = 0, Religion_NS = 0, BornOverseas_NS = 0, Language_NS = 0, Tenure_NS = 0, HighSchool_NS = 0, InternetUse_NS = 0, University_NS = 0, Volunteer_NS = 0, InternetAccess_NS = 0, SP_House = 0, Couple_NoChild_House = 0, OneParent_House = 0, Couple_WChild_House = 0, Owned = 0, Mortgage = 0, Renting = 0, PublicHousing = 0, Born_UK = 0, Born_SE_Europe = 0, Born_MidEast = 0, Born_Asia = 0, DiffAddress = 0, Extractive = 0, Transformative = 0, Distributive = 0, Finance = 0, SocialServ = 0, ManagerAdminClericalSales = 0, Professional = 0, Tradesperson = 0, Laborer = 0, DipCert = 0, Anglican = 0, OtherChrist = 0, Other_NonChrist = 0)

abs2006_e07 <- data.frame(ID = 0, Electorate = CED_list_2006_e07$Electorate, State = CED_list_2006_e07$State, Population = 0, Area = 0, MedianPersonalIncome = 0, Unemployed = 0, LFParticipation = 0, BachelorAbv = 0, Christianity = 0, Catholic = 0, Buddhism = 0, Islam = 0, Judaism = 0, NoReligion = 0, Age00_04 = 0, Age05_14 = 0, Age15_19 = 0, Age20_24 = 0, Age25_34 = 0, Age35_44 = 0, Age45_54 = 0, Age55_64 = 0, Age65_74 = 0, Age75_84 = 0, Age85plus = 0, BornOverseas = 0, Indigenous = 0, EnglishOnly = 0, OtherLanguageHome = 0, Married = 0, DeFacto = 0, FamilyRatio = 0, CurrentlyStudying = 0, HighSchool = 0, InternetUse = 0, InternetAccess = 0, AusCitizen = 0, AverageHouseholdSize = 0, MedianHouseholdIncome = 0, MedianFamilyIncome = 0, MedianRent = 0, MedianLoanPay = 0, MedianAge = 0, EmuneratedElsewhere = 0, Volunteer = 0, PersonalIncome_NS = 0, FamilyIncome_NS = 0, HouseholdIncome_NS = 0, Rent_NS = 0, Religion_NS = 0, BornOverseas_NS = 0, Language_NS = 0, Tenure_NS = 0, HighSchool_NS = 0, InternetUse_NS = 0, University_NS = 0, Volunteer_NS = 0, InternetAccess_NS = 0, SP_House = 0, Couple_NoChild_House = 0, OneParent_House = 0, Couple_WChild_House = 0, Owned = 0, Mortgage = 0, Renting = 0, PublicHousing = 0, Born_UK = 0, Born_SE_Europe = 0, Born_MidEast = 0, Born_Asia = 0, DiffAddress = 0, Extractive = 0, Transformative = 0, Distributive = 0, Finance = 0, SocialServ = 0, ManagerAdminClericalSales = 0, Professional = 0, Tradesperson = 0, Laborer = 0, DipCert = 0, Anglican = 0, OtherChrist = 0, Other_NonChrist = 0)
```
...
excel_ref <- paste0("/Users/Jeremy/Documents/R/Data/Raw/ABS2001/Unzipped/BCP_CED", CED, ".xls")
...
abs2001$Bachelor[i] = (as.numeric(temp_sheet[10,4]) / popl) * 100
abs2001$Postgraduate[i] = (as.numeric(temp_sheet[8,4]) / popl) * 100
abs2001$University_NS = (as.numeric(temp_sheet[13,4]) / as.numeric(temp_sheet[16,4]))*100 #not stated (includes inadequately described) out of age 15+

# Diploma or Certificate
abs2001$DipCert[i] = ((as.numeric(temp_sheet[11,4]) + as.numeric(temp_sheet[12,4]))/ popl) * 100
}
```
...
for (i in 1:nrow(CED_list_2006)) {
elec <- CED_list_2006$Electorate[i]; state <- CED_list_2006$State[i]; ES <- paste0(paste0(elec,"-"),state)
excel_ref <- paste0("/Users/Jeremy/Documents/R/Data/Raw/ABS2006/Unzipped/CED2004/20010-BCP-", ES, " (Commonwealth Electoral Division 2004).xls")
temp_sheet <- read_excel(excel_ref, sheet = sheet_ref)
...
- repeat the excel reference as in B 01a for all chunks
- run to create


Each of the following chunks corresponds with a particular sheet, which may have numerous metrics derived from it. 

20010-BCP-Adelaide-SA (Commonwealth Electoral Division 2004)
20010-BCP-Adelaide  (CED07)-SA (Commonwealth Electoral Division 2007)
20010-BCP-Adelaide(CED07)-SA(CommonwealthElectoralDivision2007)

B 01a
```{r B_01a_2006_e07, echo=FALSE}
sheet_ref <- "B 01a"
...
excel_ref <- paste0("/Users/Jeremy/Documents/R/Data/Raw/ABS2006/Unzipped/CED2007/20010-BCP-", ES, "(CommonwealthElectoralDivision2007).xls")
...
table(abs2006_e07$Area == 0)
```

B_02
```{r B_02_2006_e07, echo=FALSE}
sheet_ref <- "B 02"
...
B 13
Religion
Currently Studying - Have not removed not stated because this is not available in 2016.
```{r B_11_2006_e07, echo=FALSE}
sheet_ref <- "B 13"
...
# Alphabetical order of electorates, and upper case
```{r}
...
abs2001$DivisionNm <- as.character(abs2001$DivisionNm)
abs2001$DivisionNm[117] <- "O'Connor"
abs2001$DivisionNm <- toupper(abs2001$DivisionNm)
abs2001$DivisionNm <- as.factor(abs2001$DivisionNm)

abs2006$DivisionNm <- toupper(abs2006$DivisionNm)
abs2006_e07$DivisionNm <- toupper(abs2006_e07$DivisionNm)


save(abs2001, file = "/Users/Jeremy/Documents/R/Data/Clean/abs2001.rda")
save(abs2006, file = "/Users/Jeremy/Documents/R/Data/Clean/abs2006.rda")
save(abs2006_e07, file = "/Users/Jeremy/Documents/R/Data/Clean/abs2006_e07.rda")
```
