...
G13D_LanguageHome <- read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G13D_AUST_CED.csv")
...
#G19_Volunteer <- bind_rows(
#  read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G19A_AUST_CED.csv"),
#  read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G19A_AUST_CED.csv"),
#  read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G19A_AUST_CED.csv")
#)

G25_Family <- read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G25_AUST_CED.csv")
G28_FamilyIncome <- read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G28_AUST_CED.csv")
G29_HouseholdIncome <- read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G29_AUST_CED.csv")
G31_NumberInHouse <- read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G31_AUST_CED.csv")
G33_Tenure <- read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G33_AUST_CED.csv")
G36_Rent <- read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G36_AUST_CED.csv")
...
G40_Employ <- read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G40_AUST_CED.csv")
G42_Address <- read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G42_AUST_CED.csv")
G46B_Uni <- read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G46B_AUST_CED.csv")
G51_Industry <- 
  cbind(read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G51A_AUST_CED.csv"),
        read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G51B_AUST_CED.csv"),
        read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G51C_AUST_CED.csv"))
G57_Occupation <- 
  cbind(read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G57A_AUST_CED.csv"),
        read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_G57B_AUST_CED.csv"))

#Area_sqkm <- read_csv("data-raw/census/data/2021 Census GCP Commonwealth Electoral Division for AUS/2021Census_geog_desc_1st_and_2nd_release.csv")
...
new <- G1_Main %>% mutate(
  ...
  #G42
  DiffAddress = (1 - (G42_Address$Sme_Usl_ad_5_yr_ago_as_2021_P/(G42_Address$Tot_P)))*100,
