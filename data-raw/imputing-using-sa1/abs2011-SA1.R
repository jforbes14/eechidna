## This script creates the abs2011_cd dataframe from the ABS Census 2011 Datapacks
...
B1_Main<- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B01_AUST_SA1_short.csv")
B02_Medians <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B02_AUST_SA1_short.csv")
B06_Marriage <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B06_AUST_SA1_short.csv")
B09_BornOverseas <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B09_AUST_SA1_short.csv")
B13_LanguageHome <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B13_AUST_SA1_short.csv")
B14_Religion <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B14_AUST_SA1_short.csv")
B15_Study <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B15_AUST_SA1_short.csv")
B16A_HighSchool <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B16A_AUST_SA1_short.csv")
B16B_HighSchool <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B16B_AUST_SA1_short.csv")
B17B_Income <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B17B_AUST_SA1_short.csv")
B19_Volunteer <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B19_AUST_SA1_short.csv")
B25_Family <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B25_AUST_SA1_short.csv")
B26_FamilyIncome <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B26_AUST_SA1_short.csv")
B28_HouseholdIncome <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B28_AUST_SA1_short.csv")
B30_NumberInHouse <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B30_AUST_SA1_short.csv")
B32_Tenure <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B32_AUST_SA1_short.csv")
B34_Rent <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B34_AUST_SA1_short.csv")
B35_Internet <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B35_AUST_SA1_short.csv")
B37_Employ <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B37_AUST_SA1_short.csv")
B39_Address <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B39_AUST_SA1_short.csv")
B40B_Uni <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B40B_AUST_SA1_short.csv")
B43C_Industry <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B43C_AUST_SA1_short.csv")
B43D_Industry <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B43D_AUST_SA1_short.csv")
B45B_Occupation <- read_csv("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/2011 Census BCP Statistical Areas Level 1 for AUST/AUST/2011Census_B45B_AUST_SA1_short.csv")
Area_sqkm <- read_excel("/Volumes/J_External_HD/eechidna-paper-storage/2011_BCP_SA1_for_AUST_short-header/Metadata/2011Census_geog_desc_1st_and_2nd_release.xlsx")
...
abs2011_cd <- new_2011[ ,c(110:122,124:ncol(new_2011))]

# Change BornOverseas to BornElsewhere
abs2011_cd <- abs2011_cd %>%
  mutate(BornElsewhere = BornOverseas - Born_MidEast - Born_SE_Europe - Born_UK) %>% 
  select(-BornOverseas) %>% 
  select(CD, Population, Area, everything())

# Save nominal
abs2011_cd_nominal <- abs2011_cd
save(abs2011_cd_nominal, file = "/Volumes/J_External_HD/eechidna-paper-storage/abs2011_cd_nominal.rda")
...
# Save
save(abs2011_cd, file = "sa1/abs2011_cd.rda")
