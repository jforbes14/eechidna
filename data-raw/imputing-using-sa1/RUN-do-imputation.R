...
source('data-raw/imputing-using-sa1/src/Census-to-Dataframe-Compact-CD.R')

# Construct data frame for 2011 Census SA1 data
source('data-raw/imputing-using-sa1/src/abs2011-SA1.R')

# Construct data frame for 2016 Census SA1 data
source('data-raw/imputing-using-sa1/src/abs2016-SA1.R')

# Map SA1s (collection districts, "CD") to electorates
source('data-raw/imputing-using-sa1/src/mapping-CD-to-electorate.R')

# Do imputation using the mapping and census data
source('data-raw/imputing-using-sa1/src/mimputing-census-sa1.R')
