...
# Mapping electoral boundaries at Census time to boundaries at time of the election.

# Requires the shapefiles to compute intersections
library(rgdal)
sF_01 <- get_electorate_shapefile("/Users/Jeremy/Documents/R/eechidna/Shapefiles/asgc2001.gpkg")
sF_04 <- get_electorate_shapefile("/Users/Jeremy/Documents/R/Data/Raw/Shapefiles/2923030001ced04aaust/CED04aAUST_region.shp")
sF_07 <- get_electorate_shapefile("/Users/Jeremy/Documents/R/Data/Raw/Shapefiles/2923030001ced07aaust/CED07aAUST_region.shp")
sF_10 <- get_electorate_shapefile("/Users/Jeremy/Documents/R/Data/Raw/Shapefiles/national-esri-2010/COM_ELB_2010_region.shp")
sF_13 <- get_electorate_shapefile("/Users/Jeremy/Documents/R/eechidna/Shapefiles/national-midmif-16122011/COM20111216_ELB.MIF")
sF_16 <- get_electorate_shapefile("/Users/Jeremy/Documents/R/eechidna/Shapefiles/national-midmif-09052016/COM_ELB.TAB")
...
poly1 <- sF_16 %>% subset(elect_div == "BANKS")

poly2 <- sF_13 %>% subset(elect_div == "BANKS")

raster::intersect(poly1, poly2) -> x
plot(poly1)
plot(poly2, add = TRUE)
...
# This function works with shapefiles - not with the fortified maps
...
test <- Mapping_fn(aec_sF = sF_13, abs_sF = sF_16)
